const cards = [
  ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Family', 'Nature'],
  [
    {
      word: 'cry',
      translation: 'плакать',
  ...
  [
    ...
    {
      word: 'cousin',
      translation: 'двоюродный брат или сестра',
      image: './img/cousin.png',
      audioSrc: './audio/cousin.mp3',
    },
    {
      word: 'grandmother',
      translation: 'бабушка',
    ...
    },
    {
      ...
      image: './img/relative.png',
      audioSrc: './audio/relative.mp3',
    },
  ],
  [
    {
